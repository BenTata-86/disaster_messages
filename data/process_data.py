...
def load_data(messages_filepath, categories_filepath):
    ...
    Loads the files and merge two files into a dataframe
    

    Args:
        messages_filepath : path for the messages data
        categories_filepath : path for the categories data
...
def clean_data(df):
    ...
    4. Remove duplicates and remove wrong entries in 'related' column.    
    ...
    # drop duplicates and wrong entries
    df = df[df.related !=2]
